...
std::vector<std::string> get_matches(const std::string& str, std::regex reg, int max_matches = INT_MAX)
{
...
int main()
{
    ...
    //std::cout << workdir;
    for (auto& p : fs::recursive_directory_iterator("ecs"))
    {
