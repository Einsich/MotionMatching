...
public:
	...
	{
		glUniform1fv(glGetUniformLocation(program, name), matrices.size(), matrices.data());
	}
	...
	{
		glUniform2fv(glGetUniformLocation(program, name), matrices.size(), glm::value_ptr(matrices[0]));
	}
	...
	{
		glUniform3fv(glGetUniformLocation(program, name), matrices.size(), glm::value_ptr(matrices[0]));
	}
	...
	{
		glUniform4fv(glGetUniformLocation(program, name), matrices.size(), glm::value_ptr(matrices[0]));
	}
